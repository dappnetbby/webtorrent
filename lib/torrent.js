...
class Torrent extends EventEmitter {
  constructor (torrentId, client, opts) {
    ...
    this.axonNode = null
    this.initAxon().then(node => { this.axonNode = node })
  }
  ...
  _registerPeer (newPeer) {
    ...
    // this.on('piece-verified', (pieceInfo) => {
    //   // console.log('piece-verified')
    //   if(!this.axonNode) return
    //   this.axonNode.download([
    //     {
    //       key: 'download-checked',
    //       torrent: this.infoHash,
    //       // from_peer: newPeer.id,
    //       // to_peer: this.client.peerId,
    //       from_peer: newPeer.wire.peerId,
